const portfolioData = {
  ...
  works: [
    ...
    { id: 'flora', title: '海胆眼影盘', type: '品牌视觉', year: '2024', category: 'visual', description: '以海胆形态为灵感的眼影盘视觉设计，结合大胆色彩、产品造型与年轻化美妆品牌表达。', tags: ['Art Direction', 'Packaging', 'Beauty Branding'], color: 'yellow', number: '04' }
  ],
  experience: [
